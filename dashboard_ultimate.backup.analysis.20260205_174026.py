...
# Navigation
view = st.radio("Navigation", ["🗺️ Statewide Map", "📍 District View", "🚧 Live IDOT Map", "💰 Federal Funding", "🤖 AV Policy"], horizontal=True)
...
# FEDERAL FUNDING
    ...
    exec(open('1770333102181_federal_funding_tab_2_.py').read())
    create_funding_tab()
